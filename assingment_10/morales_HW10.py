...
# %%
# Look at the statistics of historical flows for Oct. 31-Nov. 6 since 1989
flows_1989_to_2020 = add_dQ_df(historical_flow(data, 1989, 10, 31, 6, 11))
week_stat(flows_1989_to_2020)

# %%
# Explore long term patterns of flow for Oct. 31-Nov. 6 since
# 1989 through graphs
flow_analysis(flows_1989_to_2020)

# %%
# Gather data for week 1 and 2 forecasts
wk1 = add_dQ_df(historical_flow(data, 2010, 10, 31, 6, 11))
wk2 = add_dQ_df(historical_flow(data, 2010, 11, 7, 13))
