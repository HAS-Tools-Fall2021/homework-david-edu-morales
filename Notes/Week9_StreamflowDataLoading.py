...
# %%
# USGS 09471000 SAN PEDRO RIVER AT CHARLESTON, AZ.
station_id = "09471000"
start_date = "1989-01-01"
stop_date = "2020-10-17"

obs_sanpedro = nwis.get_record(sites=station_id, service='dv',
                          start=start_date, end=stop_date, parameterCd='00060')

# %%
# USGS 09494000 WHITE RIVER NEAR FORT APACHE, AZ.
station_id="09494000"
start_date = "1989-01-01"
stop_date = "2020-10-17"

obs_whiteriver = nwis.get_record(sites=station_id, service='dv',
                          start=start_date, end=stop_date, parameterCd='00060')
# %%
oct_sp = obs_sanpedro.groupby([month])