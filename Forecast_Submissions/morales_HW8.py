...
# %%
# Pulling data from streamflow8.txt
...
# %%
# Look at the statistics of historical flows for Oct. 17-23 since 1989
flows_1989_to_2020 = add_dQ_df(historical_flow(data, 1989, 10, 17, 23))
week_stat(flows_1989_to_2020)

# %%
# Explore long term patterns of flow for Oct. 17-23 since 1989 through graphs
flow_analysis(flows_1989_to_2020)

# %%
# Gather data for week 1 and 2 forecasts
wk1 = add_dQ_df(historical_flow(data, 2010, 10, 17, 23))
wk2 = add_dQ_df(historical_flow(data, 2010, 10, 24, 30))
